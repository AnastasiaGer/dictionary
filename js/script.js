    ...
    items: [
      {
        ...
        description:
          "<p><dfn>Базальные эмоции</dfn> — теоретический конструкт, объединяющий эмоции минимального набора, на базе которых формируется все многообразие эмоциональных процессов и состояний. К подобным эмоциям относят эмоции радости, горя (печали), страха, гнева, удивления, отвращения.</p>",
        cite: "Материал из Википедии — свободной энциклопедии",
      },
      {
        term: "Бионика",
        description:
          '<p><dfn>Био́ника</dfn> (от <a href="#">др.-греч.</a> βίον «живущее») — прикладная наука о применении в технических устройствах и системах принципов организации, свойств, функций и структур живой природы, то есть формах живого в природе и их промышленных аналогах.</p>',
        cite: "Материал из Википедии — свободной энциклопедии",
      },
    ],
  },
...
const render = () => {
  ...
  const itemsElementsString = terms.map(createSectionString).join("");

  addChildElementsFromString(navContainer, navElementsString);
  addChildElementsFromString(glossaryContainer, itemsElementsString);
};
